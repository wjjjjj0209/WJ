...
def main():
    ...
    if os.path.exists('./generatorweights/gweights.index'):
        print('-------------load the model-----------------')
        generator.load_weights('./generatorweights/gweights')
        discriminator.load_weights('./discriminatorweights/dweights')
    ...
    generator.save_weights('./generatorweights/gweights')
    discriminator.save_weights('./discriminatorweights/dweights')
