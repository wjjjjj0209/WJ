    ...
    for epoch in range(config.epochs):
        ...
        for step, x_train in enumerate(train_db):
            ...
            for i in range(6 - level):
                x_train = GDmodel.downsampling2d(x_train)
            ...
            with tf.GradientTape() as tape:
                fake_img = generator.gerenate(z_input, level, transit, trans_alpha)
                ...
                alpha = tf.random.uniform(shape=[x_train.shape[0], 1, 1, 1], minval=-1, maxval=1)
