...
class Discriminator(Model):
    def __init__(self):
        ...
        self.c3 = Conv2D(256, 2, 2, padding='valid')
        self.b2 = BatchNormalization()
        self.a3 = Activation(tf.nn.leaky_relu)
...
def main():
    ...
    if os.path.exists('./GAN1/generatorweights/gweights.index'):
        print('-------------load the model-----------------')
        generator.load_weights('./GAN1/generatorweights/gweights')
        discriminator.load_weights('./GAN1/discriminatorweights/dweights')
    ...
    generator.save_weights('./GAN1/generatorweights/gweights')
    discriminator.save_weights('./GAN1/discriminatorweights/dweights')
